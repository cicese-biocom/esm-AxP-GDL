...
from src_old.workflow.ad_methods import build_model
from src_old.workflow.features import filter_features, FeaturesContext
from src_old.graph.construct_graphs import construct_graphs
from src_old.models.GAT.GAT import GATModel
...
class GDLWorkflow(ABC):
    def run_workflow(self, context: ApplicationContext, parameters: Dict) -> None:
        ...
        LoggingHandler.initialize_logger(logger_settings_path=Path('settings').joinpath('logging.json'),
