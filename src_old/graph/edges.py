...
import pandas as pd
from src_old.graph.tertiary_structure_handler import predict_tertiary_structures, load_tertiary_structures
from src_old.graph.edge_construction_functions import EdgeConstructionContext
from src_old.utils.scrambling import random_coordinate_matrix
...
def get_edges(workflow_settings: ParameterSetter, data: pd.DataFrame, esm2_contact_maps):
    if workflow_settings.tertiary_structure_method:
        ...
        atom_coordinates_matrices = load_tertiary_structures(workflow_settings, data)
...
def _construct_edges(atom_coordinates_matrices: np.array, sequences: List[str], esm2_contact_maps, workflow_settings: ParameterSetter):
    ...
    args = [(workflow_settings.edge_construction_functions,
             ...
             sequence,
             esm2_contact_map,
             workflow_settings.probability_threshold,
