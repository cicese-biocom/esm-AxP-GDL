...
class GATModel(nn.Module):
    def __init__(self, node_feature_dim, hidden_dim, output_dim, drop, heads, k, add_self_loops):
        ...
        self.conv1 = GATv2Conv(node_feature_dim, hidden_dim, heads=heads, add_self_loops=add_self_loops)
        self.conv2 = GATv2Conv(heads * hidden_dim, hidden_dim, heads=heads, add_self_loops=add_self_loops)
        self.conv3 = GATv2Conv(heads * hidden_dim, hidden_dim, heads=heads, concat=False, add_self_loops=add_self_loops)
